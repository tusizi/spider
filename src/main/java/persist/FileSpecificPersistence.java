...
public class FileSpecificPersistence implements Persistence {
    ...
    public FileSpecificPersistence(String fileName) {
    ...
    public void saveArticle(Article article) {
        ...
        try {
            ...
            String dir = System.getProperty("user.dir") + File.separator + fileName;
            File file = new File(dir);
            FileSpecificPersistence.ids.add(article.getId());
            if (!file.exists()) {
